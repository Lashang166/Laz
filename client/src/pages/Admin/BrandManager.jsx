...
const BrandManager = () => {
  ...
  const submitHandle = e => {
      e.preventDefault()
      axios.post("/api/brand/create", {name: brand})
          .then(res => {
  ...
  const onDelete = (id) => {
    ...
    return (
        ...
        <Typography className="mt-6 text-center" fullWidth variant="h5" color="initial">แบรนด์</Typography>
        <div className="flex pt-7 w-full space-x-3" >
            <TableContainer component={Paper}>
                ...
                />
                <Button type="submit" color="primary" variant="contained" className="mt-5 w-full">เพิ่ม</Button>
                </Paper>
        </div>
